...
> **R:**Porque al generar programa.i se agrega todo el contenido de las librerias y se expanden los defines.
...
> **R:**Porque el patron no existe en programa.i
...
> **R:**Son marcadores de Linea, comunican al compilador el número de línea original y el nombre del archivo de donde proviene el código.
...
> **R:**Estas instrucciones corresponden al "prólogo" de la función
...
Escribí solo la letra (una mayúscula):U
...
> **R:**Es U en programa.o porque solo se hace una referencia a la función. Es T en matematica.o porque ahí es donde la función está definida y se encuentra su código real.
...
> **R:**Aparece un error de ejecución indicando que no es un archivo ejecutable
...
> **R:**Quedan símbolos U porque son funciones de bibliotecas externas.
...
> **R:**La macro es un reemplazo de texto del Preprocesador y no verifica tipos. La función es código real procesado por el Compilador, tiene su propia dirección de memoria y sí verifica tipos de datos.
...
> **R:**La diferencia es que T representa código ejecutable y vive en la sección .text, mientras que D representa variables globales inicializadas y vive en la sección .data
